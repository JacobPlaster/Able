...
public class ramp_left_1 extends WorldSegment{
	...
	/**
	 * 
	 * Creates a ramp that ramps from left to right, the left side being the highest. The rams size is the same as screenHeight/7
	 * 
	 * @param screenWidth
	 * @param screenHeight
	 ...
	 * @param posInChunk
	 */
	public ramp_left_1(int screenWidth, int screenHeight, String screenResolution, Player p, int startHeight, int startWidth, int posInChunk)
	{
		...
		System.out.println("ramp_left_1 created.");
	}
	...
	public void create() {
		...
		leftRamp.setSize(screenWidth, screenHeight/7);
	...
	public void render(SpriteBatch batch) {
		...
		leftRamp.draw(batch);
		batch.draw(autoFiller, (widthPos), startHeight + screenHeight/7 - (startHeight - screenHeight/3)*2 -2, screenWidth, screenHeight);
