...
public class ramp_right_4 extends WorldSegment{
	...
	/**
	 * 
	 * Creates a ramp that ramps from right to left, the right side being the highest. The rams size is the same as screenHeight/10
	 * 
	 * @param screenWidth
	 * @param screenHeight
	 ...
	 * @param posInChunk
	 */
	public ramp_right_4(int screenWidth, int screenHeight, String screenResolution, Player p, int startHeight, int startWidth, int posInChunk)
	{
		...
		System.out.println("ramp_right_4 created.");
	}
