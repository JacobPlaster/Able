...
/**
 * Creates a ramp that uses the ramp_left_1.png image, this ramp is the same size as screenHeight/6
 */
public class ramp_left_3 extends WorldSegment{
	...
	public ramp_left_3(int screenWidth, int screenHeight, String screenResolution, Player p, int startHeight, int startWidth, int posInChunk)
	{
		...
		System.out.println("ramp_left_3 created.");
	}
	...
	public void create() {
		...
		leftRamp.setSize(screenWidth, screenHeight/6);
	...
	public void render(SpriteBatch batch) {
		...
		leftRamp.draw(batch);
		batch.draw(autoFiller, (widthPos), (startHeight + screenHeight/6) - (startHeight - screenHeight/3)*2 -2, screenWidth, screenHeight);
