...
public class ramp_left_4 extends WorldSegment{
	...
	/**
	 * 
	 * Creates a ramp that ramps from left to right, the left side being the highest. The rams size is the same as screenHeight/10
	 * 
	 * @param screenWidth
	 * @param screenHeight
	 ...
	 * @param posInChunk
	 */
	public ramp_left_4(int screenWidth, int screenHeight, String screenResolution, Player p, int startHeight, int startWidth, int posInChunk)
	{
		...
		System.out.println("ramp_left_4 created.");
	}
	...
	public void create() {
		...
		leftRamp.setSize(screenWidth, screenHeight/10);
	...
	public void render(SpriteBatch batch) {
		...
		leftRamp.draw(batch);
		batch.draw(autoFiller, (widthPos), (startHeight + screenHeight/10) - (startHeight - screenHeight/3)*2 -2, screenWidth, screenHeight);
