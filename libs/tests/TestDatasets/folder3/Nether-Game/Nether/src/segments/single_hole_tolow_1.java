...
public class single_hole_tolow_1 extends WorldSegment{
	...
	public single_hole_tolow_1(int screenWidth, int screenHeight, String screenResolution, Player p, int startHeight, int startWidth, int posInChunk)
	{
		...
		System.out.println("Single_Hole_tolow_1.");
	}
