...
/**
 * Creates a ramp that uses the ramp_right_1.png image, this ramp is the same size as screenHeight/6
 */
public class ramp_right_3 extends WorldSegment{
	...
	/**
	 * 
	 * Creates a ramp that ramps from right to left, the right side being the highest. The rams size is the same as screenHeight/6
	 * 
	 * @param screenWidth
	 * @param screenHeight
	 ...
	 * @param posInChunk
	 */
	public ramp_right_3(int screenWidth, int screenHeight, String screenResolution, Player p, int startHeight, int startWidth, int posInChunk)
	{
		...
		System.out.println("ramp_right_3 created.");
	}
