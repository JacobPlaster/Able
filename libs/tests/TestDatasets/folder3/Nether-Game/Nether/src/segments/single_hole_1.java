...
public class single_hole_1 extends WorldSegment{
	...
	public single_hole_1(int screenWidth, int screenHeight, String screenResolution, Player p, int startHeight, int startWidth, int posInChunk)
	{
		...
		System.out.println("Single_Hole_1.");
	}
	...
	public void create() {
		...
		rightCorner.setPosition(holeEndWidth,
				 startHeight - (startHeight - screenHeight/3)*2);
		
		rightLining = new Sprite(leftLining);
		rightLining.setFlip(true, false);
		rightLining.setSize(screenWidth/45, (startHeight + leftCorner.getRegionHeight()) - (screenHeight - (startHeight + leftCorner.getRegionHeight())));
		rightLining.setPosition(holeEndWidth - rightLining.getWidth(),
				 startHeight + leftCorner.getRegionHeight() - (startHeight - screenHeight/3)*2);
	...
	public void render(SpriteBatch batch) {
		...
		// LEFT SIDE
		batch.draw(leftCorner, holeStartWidth-rightCorner.getWidth()-1, startHeight - (startHeight - screenHeight/3)*2, screenWidth/12, screenHeight/8);
		...
		batch.draw(autoFiller, holeEndWidth + rightCorner.getWidth(), startHeight - (startHeight - screenHeight/3)*2, (widthPos + screenWidth) - (holeEndWidth + rightCorner.getWidth()), screenHeight);
		batch.draw(autoFiller, holeEndWidth, (startHeight + rightCorner.getHeight()) - (startHeight - screenHeight/3)*2, (widthPos + screenWidth) - (holeEndWidth + rightCorner.getWidth()), screenHeight);
		// only draws the lining if the segment is aboe a certain height
		if(startHeight > screenHeight/2)
		{
			batch.draw(leftLining, holeStartWidth, (startHeight + leftCorner.getRegionHeight()) - (startHeight - screenHeight/3)*2, screenWidth/45, (startHeight + leftCorner.getRegionHeight()) - (screenHeight - (startHeight + leftCorner.getRegionHeight())));
			rightLining.draw(batch);
		}
